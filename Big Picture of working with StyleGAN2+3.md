...
- I haven't seen much shared about training with really tiny datasets. I've found that the 1000 to 2000 image datasets end up with a decent amount of interpolative potential. Yet for the 200 to 500 range of image datasets I had to ride the line of avoiding mode collapse by hand selecting the seeds prior to rendering out the latent walk video. In other words, the generated visuals would start to repeat itself and so I'd overcome that hand selecting and arranging the gems. I've been outputting between 10,000 and 50,000 images from Stable Diffusion and getting very good results, but the text promot must be very concise so that the visuals are strictly visualizing a certain thing. You can read more notes over on my tech journal on this aspect if you're curious, check out the [Graffiti Reset](https://www.jasonfletcher.info/vjloops/graffiti-reset.html) VJ pack. Over there I also share my experience with setting the gamma attribute and other such details.
