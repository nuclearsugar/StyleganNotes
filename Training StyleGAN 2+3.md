...
- Useful training notes here:
  ...
  - https://rpubs.com/JonasKnecht/665744
...
- Now that I'm training using much larger dataset (>30,000 images) I think that FreezeD is no longer helpful and is hindering training performance. I believe that when training tiny datasets (<500 images) then it was beneficial to help avoid overfitting at the lowest levels of the model.
...
## Interesting Reading
- [The Path to StyleGan2: Implementing the StyleGAN](https://ym2132.github.io/StyleGAN) - Documents the process of coding StyleGAN2 from scratch. Has some interesting insights.
