## My Experience with Training StyleGAN 2 & 3

JASON NOTES ON TRAINING
==================================================
• CTRL+C: cancel current task that is executing within the command prompt.
...
JASON NOTES ON TRAINING IN REGARDS TO GAMMA
==================================================
...
JASON NOTES ON TRAINING IN REGARDS TO FREEZED FOR SG2
==================================================
...
DETAILS FROM DIEGO
==================================================
I asked Diego Porres Bustamante <dporres@cvc.uab.cat> (maintainer of StyleGAN3-fun) the following:
